...
class App extends React.Component {
    ...
    addTask() {
        this.setState((state) => {
            return { addTaskClassName: state.addTaskClassName.replaceClass("btn-success", "btn-warning") }
        })
    }
    ...
    render() {
        return (
            <div className="container">
                ...
                <div className="card bg-default animated bounceIn mt-5" style={{ width: 300 }}>
                    ...
                    <div className="card-footer">
                        <a href="#" className={this.state.addTaskClassName.toClass()} onClick={this.addTask}>Add Task</a>
